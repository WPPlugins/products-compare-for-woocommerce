...
if( ! function_exists( 'br_compare_products_general_callback' ) ) {
    /**
     * Function for general settings callback
     *
     * @return void
     */
    function br_compare_products_general_callback() { 
        include Compare_Products_TEMPLATE_PATH . "general_settings.php";
    }
}

if( ! function_exists( 'br_compare_products_style_callback' ) ) {
    /**
     * Function for style settings callback
     *
     * @return void
     */
    function br_compare_products_style_callback() { 
        include Compare_Products_TEMPLATE_PATH . "style_settings.php";
    }
}

if( ! function_exists( 'br_compare_products_text_callback' ) ) {
    /**
     * Function for text settings callback
     *
     * @return void
     */
    function br_compare_products_text_callback() { 
        include Compare_Products_TEMPLATE_PATH . "text_settings.php";
    }
}

if( ! function_exists( 'br_compare_products_javascript_callback' ) ) {
    /**
     * Function for javascript settings callback
     *
     * @return void
     */
    function br_compare_products_javascript_callback() { 
        include Compare_Products_TEMPLATE_PATH . "javascript_settings.php";
    }
}

if( ! function_exists( 'br_compare_products_license_callback' ) ) {
    /**
     * Function for license settings callback
     *
     * @return void
     */
    function br_compare_products_license_callback() { 
        include Compare_Products_TEMPLATE_PATH . "license_settings.php";
    }
}
...
if ( ! function_exists( 'berocket_font_select_upload' ) ) {
    ...
    function berocket_font_select_upload( $text, $id, $name, $value, $show_fa = true, $show_upload = true, $show_remove = true, $data_sc = '' ) {
        ...
        if ( $show_fa ) {
            $result .= '<input type="button" class="berocket_aapf_font_awesome_icon_select button" value="'.__('Font awesome', 'BeRocket_Compare_Products_domain').'"/>
        ...
        if ( $show_upload ) {
            $result .= '<input type="button" class="berocket_aapf_upload_icon button" value="'.__('Upload', 'BeRocket_Compare_Products_domain').'"/> ';
        }
        if ( $show_remove ) {
            $result .= '<input type="button" class="berocket_aapf_remove_icon button" value="'.__('Remove', 'BeRocket_Compare_Products_domain').'"/>';
        }
        $result .= '</div>';
